    ...
    <div id="home" className="nav-link home">
      <div className={styles.home}>
        ...
        <div className={styles.homeLeft}>
          <div className={styles.homeLeftDescp}>
            <p>Hello, 👋 I am</p>
            <span></span>
          </div>
          <h1 id="user-detail-name">
            <span id="user-detail-name">Rahul Dudka</span> <br />
          ...
          <p id="user-detail-intro">
            ...
            <span>Javascript</span> ⚛️ <span>React </span>
          ...
          <div className={styles.Social}>
            ...
            <a
              id="contact-github"
              href="https://github.com/dRahul97"
              target="_blank"
            >
            ...
            <a href="mailto:drahul.official@gmail.com" target="_blank">
            ...
            >
              <a href={resume} target="_blank" download="Rahul-Dudka-Resume">
