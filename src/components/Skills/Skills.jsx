...
const Skills = () => {
  return (
    <section id="skills" className="nav-link skills">
      ...
      {/* Skills Container */}
      <div className="skillsContainer1 skills-card">
        <div className="skillsLeft1">
          <div className="frontendBackend1">
            <div className="skills1">
              <svg
                className="iconss skills-card-img"
                style={{ fill: "#EB5C2B" }}
            ...
            <div className="skills1">
              <img
                className="imgLogo1 skills-card-img"
                src={typescript}
                alt=""
              />
            ...
            <div className="skills1">
              <img className="imgLogo1 skills-card-img" src={redux} alt="" />
              <h3 className="skills-card-name">Redux</h3>
            </div>
            <div className="skills1">
              <img className="imgLogo1 skills-card-img" src={github} alt="" />
              <h3 className="skills-card-name">Github</h3>
            </div>
            <div className="skills1">
              <img className="imgLogo1 skills-card-img" src={vscode} alt="" />
              <h3 className="skills-card-name">VS Code</h3>
            </div>
            <div className="skills1">
              <svg
                className="iconss skills-card-img"
            ...
            <div className="skills1">
              <img className="imgLogo1 skills-card-img" src={nodejs} alt="" />
              <h3 className="skills-card-name">NodeJs</h3>
            </div>
            <div className="skills1">
              <img className="imgLogo1 skills-card-img" src={netlify} alt="" />
              <h3 className="skills-card-name">Netlify</h3>
            </div>
            <div className="skills1">
              <img className="imgLogo1 skills-card-img" src={vercel} alt="" />
              <h3 className="skills-card-name">Vercel</h3>
            </div>
            <div className="skills1">
              <img className="imgLogo1 skills-card-img" src={mongodb} alt="" />
              <h3 className="skills-card-name">MongoDB</h3>
            </div>
            <div className="skills1">
              <img className="imgLogo1 skills-card-img" src={express} alt="" />
              <h3 className="skills-card-name">Express.JS</h3>
            </div>
          </div>
        </div>
      </div>
