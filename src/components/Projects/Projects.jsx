          ...
          <div className="project1-details">
            <div>
              <h3 className="project-title">
                1. Fashion Square ( LimeRoad Clone ){" "}
              </h3>
              <span className="orangDash2"></span>
            </div>

            <p className="project-description">
              Fashion square (Limeroad clone) is an E-commerce website which is
              used to shop clothes and other products.
            </p>
            ...
            <div className="codebase">
              <a
                ...
                href="https://github.com/Avneesh002/Fashion-square"
                target="_blank"
              >
                <img src={github} alt="" />
                <p>Codebase</p>
